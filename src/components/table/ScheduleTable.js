...
const TdStyle = {
  ThStyle: `bg-[#40916c] w-1/6 min-w-[160px] border-l border-transparent py-4 px-3 text-lg font-medium text-white lg:py-7 lg:px-4 `,
        ...
        <div className=' '>
            ...
            <div className=' overflow-x-auto  '>
              <table className='w-full  '>
                <thead className='text-center bg-[2d6a4f]'>
                  <tr>
