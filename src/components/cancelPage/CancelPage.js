...
<div className=' sm:flex flex-row  '>
        <div className='flex flex-col basis-2/3 bg-white '>
              <div className=' h-[100px] w-3/4 mt-5  mx-6  items-center'>
                 <p className='text-gray-600 py-2'>location</p>
                <h3 className='text-3xl font-bold py-2 text-green '> businessname</h3>
              </div>
              <div className='img max-h-[600px]  mx-6 mt-5 '>
                 <img className='max-h-[90%] rounded w-[95%]' src={`${BASEURL}/venderImages/${pageData?.court?.image}`}/>
              </div>
...
<p className="mb-2">Sports Clubs in Rohini,We provide necessary first aid and CPR certification for the users.</p>
        ...
        <div className=' flex flex-col basis-1/3 items-center '>
                  <div className='items-center  mt-10 md:mt-24 px-2 w-[90%] '>
                   ...
                   <div className=' pt-2 '>
                    <div type="button" className=" text-center  text-green bg-white hover:bg-gray-200  cursor-pointer border border-gray-400  font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 "><FontAwesomeIcon className='text-green-900 ' icon={faShareFromSquare} /> Share</div>
              ...
              <button type="button" className= "w-1/5 text-white bg-gradient-to-r from-green-500 via-green-700 to-green-900 hover:bg-gradient-to-br focus:ring-2 focus:outline-none focus:ring-green-500 dark:focus:ring-green-800 font-medium rounded-lg text-sm py-2  text-center me-2 mt-1 mb-2 " >search</button>
